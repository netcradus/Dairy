...
abstract class AppTheme {
  ...
  static ThemeData get lightTheme {
    ...
    return ThemeData(
      ...
      // Card Theme — clean white surface, subtle border, 16px radius
      ...
      // Elevated Button Theme — capsule shape
      ...
      // Outlined Button Theme — capsule with light blue fill
      ...
      // Input Decoration Theme — pill-shaped search/input
      ...
      // Bottom Navigation Bar Theme — active solid blue
