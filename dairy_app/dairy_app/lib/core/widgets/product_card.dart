...
/// Product Card — clean white surface, subtle border, discount badge,
/// product name, weight/volume, price with strikethrough, and blue + / Add button.
      ...
      child: AnimatedContainer(
        ...
        child: InkWell(
          ...
          child: Column(
            ...
            children: [
              // Product Image Header with Discount Badge
              Expanded(
                child: Stack(
                  children: [
                    Container(
